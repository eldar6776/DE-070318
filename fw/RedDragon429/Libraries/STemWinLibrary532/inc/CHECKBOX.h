...
#define CHECKBOX_EnableMemdev(hObj)  WM_EnableMemdev    (hObj)
#define CHECKBOX_DisableMemdev(hObj) WM_DisableMemdev   (hObj)
#define CHECKBOX_Delete(hObj)        WM_DeleteWindow    (hObj)
/*********************************************************************
*
*       Member functions
*
