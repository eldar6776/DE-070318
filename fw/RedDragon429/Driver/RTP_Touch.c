...
extern void TimeDelay(uint32_t time);
GUI_PID_STATE State;
...
void FS5206_Init(void)
{
	...
	TimeDelay(1000);
	FS5206_WriteByte(FT5206_WRITE_ADDRESS, FT5206_DEVICE_MODE, 0);
	FS5206_ReadXY();
}
...
void FS5206_WriteByte(uint8_t dev_address, uint8_t data_address, uint8_t data)
{
...
void FS5206_ReadBytes(uint8_t dev_address, uint8_t data_address, uint8_t *buff, uint8_t size)
{
	uint32_t timeout;
	uint8_t n;
...
void FS5206_WriteBytes(uint8_t dev_address, uint8_t data_address, uint8_t *buff, uint8_t size)
{
	uint32_t timeout;
	uint8_t n;
...
{
	int16_t ax[5], ay[5], tp_x[5], tp_y[5];
	ax[0] = 20;             ay[0] = 20;
