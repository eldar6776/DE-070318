...
/* Constante ----------------------------------------------------------------*/
const char sys_info[] = "HW: RedDragon F429, REV:1,0;      FW: HC070318";
...
//	subnet_mask[3] = i2c_ee_buffer[3];
	subnet_mask[0] = NETMASK_ADDR0;
	subnet_mask[1] = NETMASK_ADDR1;
	subnet_mask[2] = NETMASK_ADDR2;
	subnet_mask[3] = NETMASK_ADDR3;
