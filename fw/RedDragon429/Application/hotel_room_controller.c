...
/** ==========================================================================*/
/**                                                                           */
/**   C A L C U L A T E    C R C  3 2    F O R    F I R M W A R E   F I L E   */ 
/**                                                                           */
/** ==========================================================================*/
	CRC_ResetDR();
	crc_32_file = 0;
...
void CONTROLLER_WriteLogEvent(uint8_t log_event, uint16_t event_detail)
{
	...
	i2c_ee_buffer[5] = (event_detail << 8);
	i2c_ee_buffer[6] = (event_detail & 0xff);
	i2c_ee_buffer[7] = 0xff;
	i2c_ee_buffer[8] = 0xff;
	i2c_ee_buffer[9] = 0xff;
