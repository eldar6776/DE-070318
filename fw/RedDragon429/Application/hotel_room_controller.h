...
#define RUBICON_BOOTLOADER_UPDATE_FAIL			((uint8_t)0xcb)
#define RUBICON_BOOTLOADER_UPDATED				((uint8_t)0xcc)
#define RUBICON_IMAGE_UPDATED					((uint8_t)0xcd)
#define RUBICON_FIRMWARE_UPDATE_FAIL			((uint8_t)0xce)
#define RUBICON_IMAGE_UPDATE_FAIL				((uint8_t)0xcf)	
...
#define RUBICON_SET_MIFARE_AUTHENTICATION_KEY_A	((uint8_t)0xdc)
#define RUBICON_SET_MIFARE_AUTHENTICATION_KEY_B	((uint8_t)0xdd)
...
void CONTROLLER_WriteLogEvent(uint8_t log_event, uint16_t event_detail);
