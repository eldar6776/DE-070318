...
//void FormatFileSectors(uint32_t start_address, uint8_t number_of_block);
...
/**
  ...
  * @retval error value
  */
int tftp_send_data_packet(struct udp_pcb *upcb, struct ip_addr *to, int to_port, unsigned short block, char *buf, int buflen)
{
...
void wrq_recv_callback(void *arg, struct udp_pcb *upcb, struct pbuf *pkt_buf, struct ip_addr *addr, u16_t port)
{
      ...
      (tftp_extract_block(pkt_buf->payload) == (args->block + 1)))
  {
	...
	*																*
	*****************************************************************/
//	 W25Qxx_Write(next_address, (uint8_t *) pkt_buf->payload + TFTP_DATA_PKT_HDR_LEN, pkt_buf->len - TFTP_DATA_PKT_HDR_LEN);
//	 next_address += n;
  ...
  {
		/**
		*	write to last 4 byte file lenght
		*/
//		uint8_t d[4];
//		d[0] = args->tot_bytes >> 24;
//		d[1] = args->tot_bytes >> 16;
//		d[2] = args->tot_bytes >> 8;
//		d[3] = args->tot_bytes;
//	  
//		if(barrier_tftp_file == FILE_UPDATE_IMAGE_1) W25Qxx_Write((W25QXX_IMAGE_1_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_2) W25Qxx_Write((W25QXX_IMAGE_2_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_3) W25Qxx_Write((W25QXX_IMAGE_3_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_4) W25Qxx_Write((W25QXX_IMAGE_4_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_5) W25Qxx_Write((W25QXX_IMAGE_5_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_6) W25Qxx_Write((W25QXX_IMAGE_6_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_7) W25Qxx_Write((W25QXX_IMAGE_7_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_8) W25Qxx_Write((W25QXX_IMAGE_8_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_9) W25Qxx_Write((W25QXX_IMAGE_9_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_10) W25Qxx_Write((W25QXX_IMAGE_10_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_11) W25Qxx_Write((W25QXX_IMAGE_11_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_12) W25Qxx_Write((W25QXX_IMAGE_12_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_13) W25Qxx_Write((W25QXX_IMAGE_13_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_14) W25Qxx_Write((W25QXX_IMAGE_14_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_15) W25Qxx_Write((W25QXX_IMAGE_15_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_16) W25Qxx_Write((W25QXX_IMAGE_16_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_17) W25Qxx_Write((W25QXX_IMAGE_17_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_18) W25Qxx_Write((W25QXX_IMAGE_18_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FILE_UPDATE_IMAGE_19) W25Qxx_Write((W25QXX_IMAGE_19_END_ADDRESS - 3), d, 4);
//		else if(barrier_tftp_file == FW_FILE) W25Qxx_Write((W25QXX_FW_END_ADDRESS - 3), d, 4); 
//		barrier_tftp_file = NULL; 
	...
	* transactions for a given "stream" occur on another port!  */
	...
	switch (op)
	{
		...
		case TFTP_WRQ:		/* TFTP WRQ (write request)   */
		{
			...
			if (f_mount(&filesystem, "0:", 0) != FR_OK) return;

			if (f_opendir(&dir_2, "/") != FR_OK) return;
			
			/****************************************************************
			*																*
			*		format flash sector for new file						*
			*																*
			*****************************************************************/
			
//			if (strcmp(FileName, "NEW.BIN") == 0)
//			{
//				next_address = W25QXX_FW_START_ADDRESS;
//				barrier_tftp_file = FW_FILE;
//				W25Qxx_SectorErase(W25QXX_FW_START_ADDRESS, W25QXX_CMD_ERASE_64K);
//				W25Qxx_WaitBusy();
//			}
//			else if (strcmp(FileName, "IMG1.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_1_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_1;
//				FormatFileSectors(W25QXX_IMAGE_1_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG2.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_2_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_2;
//				FormatFileSectors(W25QXX_IMAGE_2_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG3.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_3_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_3;
//				FormatFileSectors(W25QXX_IMAGE_3_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG4.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_4_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_4;
//				FormatFileSectors(W25QXX_IMAGE_4_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG5.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_5_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_5;
//				FormatFileSectors(W25QXX_IMAGE_5_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG6.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_6_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_6;
//				FormatFileSectors(W25QXX_IMAGE_6_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG7.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_7_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_7;
//				FormatFileSectors(W25QXX_IMAGE_7_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG8.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_8_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_8;
//				FormatFileSectors(W25QXX_IMAGE_8_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG9.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_9_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_9;
//				FormatFileSectors(W25QXX_IMAGE_9_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG10.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_10_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_10;
//				FormatFileSectors(W25QXX_IMAGE_10_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG11.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_11_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_11;
//				FormatFileSectors(W25QXX_IMAGE_11_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG12.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_12_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_12;
//				FormatFileSectors(W25QXX_IMAGE_12_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG13.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_13_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_13;
//				FormatFileSectors(W25QXX_IMAGE_13_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG14.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_14_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_14;
//				FormatFileSectors(W25QXX_IMAGE_14_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG15.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_15_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_15;
//				FormatFileSectors(W25QXX_IMAGE_15_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG16.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_16_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_16;
//				FormatFileSectors(W25QXX_IMAGE_16_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG17.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_17_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_17;
//				FormatFileSectors(W25QXX_IMAGE_17_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG18.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_18_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_18;
//				FormatFileSectors(W25QXX_IMAGE_18_START_ADDRESS, 3);
//			}
//			else if (strcmp(FileName, "IMG19.RAW") == 0)
//			{
//				next_address = W25QXX_IMAGE_19_START_ADDRESS;
//				barrier_tftp_file = FILE_UPDATE_IMAGE_19;
//				FormatFileSectors(W25QXX_IMAGE_19_START_ADDRESS, 3);
//			}
...
//	bcnt = 0;
//	
//	while(bcnt < number_of_block)
//	{
//		W25Qxx_SectorErase(address, W25QXX_CMD_ERASE_64K);
//		W25Qxx_WaitBusy();
//		address += 0x00010000;
//		bcnt++;
//	}	
